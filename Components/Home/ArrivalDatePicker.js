...
class Rows extends React.Component {
	static ArrivalPrice = ["4,212","4,222","4,232","4,252","4,216","4,212","4,211","4,214","4,522","4,672","4,000","6,212","7,212","4,212","4,112","4,219","4,218","4,212","4,672","4,212","4,672","4,345","4,212","4,222","4,212","7,552","4,672","5,212","4,878","4,612","4,412"];
	constructor(props) {
		super(props);
		this.state = {
			monthArray : [],
									...
									if(value.isActive){
										return(
											<td key={index} className={value.isActive?value.isToday?"dayTodayDiv":value.isSelected?"daySelectedDiv":"dayDiv":"inActiveDayDiv"} id={ide} onClick={value.isActive?component.hanldleClickDate.bind(this ,ide):null}>
												<div>{value.Value}</div>
												<div className="priceValue">{Rows.ArrivalPrice[index]}</div>
											</td>
										);
									}
									else {
